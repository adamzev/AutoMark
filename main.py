...
answer_key = ANSWER_KEYS['BCBA8F9752']
...
for problem_number in range(len(answers)):
    ...
    for image in images:
        ...
        if ocr.confidence < 0.8:
            confident = False
            print("That was hard to read. Maybe it is a {} - {}".format(ocr.secondary_value, ocr.secondary_confidence))
...
Helpers.show(final, 'contour')
#Helpers.save_image('images/graded.png', final)