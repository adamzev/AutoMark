...
def main():
    ...
    for problem_number, _ in enumerate(answers):
    ...
    for i, contour in enumerate(contours):
        ...
        text_size = cv2.getTextSize(str(answer_key[i]), font_face, font_scale, thickness)
        ...
        cv2.putText(final, str(answer_key[i]), (text_x, text_y), font_face, font_scale, \
